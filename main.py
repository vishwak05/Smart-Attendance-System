...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':"smartattendance-95405.appspot.com"
})
        ...
        if counter!=0:
            ...
            if counter==1:
                ...
                if blob:
                    ...
                    modeType = 4
                    counter = 0
                    #print(f"Image for student ID {id} not found in storage.")
                    # You can load a default image if needed
                    #imgStudent = cv2.imread('Resources/default_student_image.png')
            ...
            if modeType!=3:
                ...
                if counter<=10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['major']), (1006, 550),
                                cv2.FONT_HERSHEY_COMPLEX, 0.36, (255, 255, 255), 1)
                    ...
                    if imgStudent is None:
                        modeType = 4
                        counter = 0
                        print("imgStudent is empty. Using a placeholder or skipping this operation.")
                    else:
